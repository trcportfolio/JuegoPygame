...
class Enemy2:
    ...
    def __init__(self, win, data):
        ...
        self.left = True
        self.fpsCounter = 0
        self.x = self.settings.enemy2pos[0][0]
        self.y = self.settings.enemy2pos[0][1]
        self.win = win
        self.battle = False

        self.draw = Spritesheet(data[0],data[1], data[2], data[3], data[6])
        self.enemyRect = pygame.Rect(self.settings.enemy2pos[0][0], self.settings.enemy2pos[0][1],
